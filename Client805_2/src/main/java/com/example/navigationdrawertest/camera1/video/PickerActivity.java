package com.example.navigationdrawertest.camera1.video;
...
import com.example.navigationdrawertest.camera1.video.adapter.FolderAdapter;
import com.example.navigationdrawertest.camera1.video.adapter.MediaGridAdapter;
import com.example.navigationdrawertest.camera1.video.adapter.SpacingDecoration;
import com.example.navigationdrawertest.camera1.video.data.DataCallback;
import com.example.navigationdrawertest.camera1.video.data.ImageLoader;
import com.example.navigationdrawertest.camera1.video.data.MediaLoader;
import com.example.navigationdrawertest.camera1.video.data.VideoLoader;
...
public class PickerActivity extends Activity implements DataCallback, View.OnClickListener {
    ...
    public void setTitleBar() {
        int type = argsIntent.getIntExtra(PickerConfig.SELECT_MODE, PickerConfig.PICKER_VIDEO);
