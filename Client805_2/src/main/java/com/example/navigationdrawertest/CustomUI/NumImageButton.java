...
public class NumImageButton extends ImageButton {
    //要显示的数量数量
    private int num = 0;
    //红色圆圈的半径
    ...
    public NumImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (num > 0) {
            ...
            //初始化边距
            paddingRight = getPaddingRight()/5;
            paddingTop = getPaddingTop()/5;
            //初始化画笔
