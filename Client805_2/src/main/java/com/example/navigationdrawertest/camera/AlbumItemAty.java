...
import com.example.navigationdrawertest.customCamera.album.view.AlbumViewPager;
import com.example.navigationdrawertest.customCamera.album.view.AlbumViewPager.OnPlayVideoListener;
import com.example.navigationdrawertest.customCamera.album.view.AlbumViewPager.ViewPagerAdapter;
import com.example.navigationdrawertest.customCamera.album.view.MatrixImageView.OnSingleTapListener;
import com.example.navigationdrawertest.customCamera.video.view.VideoPlayerContainer;
import com.example.navigationdrawertest.customCamera.video.view.VideoPlayerView;
...
//		mSaveRoot="test";
		...
		if(getIntent().getExtras()!=null){
			...
			rwId = getIntent().getExtras().getString("rwId");
//			rowNum = getIntent().getExtras().getString("rowNum");
			opId = getIntent().getExtras().getString("opId");
		}
