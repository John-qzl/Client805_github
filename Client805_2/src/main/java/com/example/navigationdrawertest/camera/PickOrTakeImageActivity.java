 ...
 */
public class PickOrTakeImageActivity extends FragmentActivity implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    private class OnclickListenerWithHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.iv_content) {
                if (isPersonalPhoto) {
                    //个人头像裁剪
                    /*Intent intent = new Intent(PickOrTakeImageActivity.this, ClipImageActivity.class);
